...
首先到仓库页面：https://github.com/lionshan/l552177239.github.io

点 Settings（设置）这一个标签。打开的页面底部有一个 “Delete this repository” 按钮，意思是”删除这个仓库“，点击按钮。打开的界面中，输入一下这个仓库的名字 lionshan.github.io 就可以把这个仓库删除了。
...
上面的步骤操作完成，就可以在 lionshan.github.io 看到网站的首页了。
